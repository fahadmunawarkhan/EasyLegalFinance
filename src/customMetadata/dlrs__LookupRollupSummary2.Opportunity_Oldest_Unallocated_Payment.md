...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Opportunity: Oldest Unallocated Payment</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Oldest_Unallocated_Payment__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Save the id of the oldest unalocated payment so that it can be allocated when a new drawdown comes in.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Date__c DESC</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Outstanding_Balance_as_of_Payout_Date__c
Payment_Method__c</value>
    </values>
    <values>
        <field>dlrs__RelationshipCriteria__c</field>
        <value xsi:type="xsd:string">Outstanding_Balance_as_of_Payout_Date__c &lt; 0  AND Payment_Method__c = &apos;Payment&apos;</value>
    </values>
    <values>
