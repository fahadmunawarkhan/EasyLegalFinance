...
({
    ...
    applyReserve: function(component) {
        ...
        action.setParams({
            oppId: oppObj.Id,
            isReserveApplied: oppObj.Is_Reserve_Applied__c,
            stopInterest: oppObj.Stop_Interest__c,
            reserveDate: oppObj.Reserve_Date__c,
            reserveAmount: oppObj.Reserve_Amount__c
        });
